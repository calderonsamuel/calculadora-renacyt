produccion_UI <- function(id) {
    ...
    tagList(
        ...
        numericInput(inputId = ns("conference"),
                     ...
                     min = 0,
                     value = 0),
        tags$h4("C. Registros de propiedad intelectual, concedidas y registradas en INDECOPI, SCOPUS u otras"),
        ...
        numericInput(inputId = ns("patente_modelo"),
                     ...
                     min = 0,
                     value = 0),
        tags$h4("D. Publicaciones de libros y/o capítulos de libro indizados"),
        numericInput(ns("libros"), "Nº de libros", min = 0, value = 0),
        numericInput(ns("capitulos"), "Nº de capítulos de libro", min = 0, value = 0),
